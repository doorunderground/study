...
void test_Matrix_Addition_Subtraction()
{
	const char* matrixDataFile = "mtrxInputData2.txt";
	FILE* fin;
	...
	printMtrx(dMC, c_row_size, c_col_size); //A+B
	printf("\n");
	...
	printMtrx(dMD, d_row_size, d_col_size); //A-B
	printf("\n");
...
void test_Matrix_Multiplication()
{
	...
	printMtrx(dMC, c_row_size, c_col_size); //AxB
	printf("\n");
